...
def _get_latest_or_fallback(doc_type: str):
    ...
    body_map = {
        LegalDocument.DocType.TERMS: (
            ...
            "Home Craft 3D provides the platform only and does not manufacture, inspect, or quality‑control items sold by sellers.\n"
            "Any guarantees, product quality, safety, or regulatory compliance are the sole responsibility of the seller.\n\n"
            "2) Accounts\n"
            ...
            "To the maximum extent permitted by law, Home Craft 3D and its staff disclaim liability for product quality, defects, or seller performance.\n\n"
            "11) Changes\n"
