...
## 2026-02-10 — Free digital listings cap enforcement
...
- Seller fulfillment queue is driven by **OrderItem fulfillment_status** for physical items only; digital items are excluded from shipping queue.
